  ...
  <div class="row justify-content-center">
    ...
    <div class="col-12 row" style="padding-bottom: 10px">
      <div class="col-12 col-md-4">
        <div style="margin-top: 10px;" class="h4">News</div>
      </div>
    ...
    <div class="col-12" style="margin-top: 10px;">
      <div class="card" style="position: relative;">
        <div class="card-body">
          <img class="imgResponsive" style="max-height: 100px"
            src="@if (str_starts_with($blog->img, 'images')) {{ asset('storage/' . $blog->img) }} @else {{ $blog->img }} @endif"
            alt="Card image cap">
          <h5 class="card-title">
